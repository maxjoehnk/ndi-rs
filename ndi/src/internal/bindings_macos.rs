...
pub const NDILIB_LIBRARY_NAME: &[u8; 13] = b"libndi.dylib\0";
pub const NDILIB_REDIST_FOLDER: &[u8; 19] = b"NDI_RUNTIME_DIR_V5\0";
pub const NDILIB_REDIST_URL: &[u8; 33] = b"http://ndi.link/NDIRedistV5Apple\0";
